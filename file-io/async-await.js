...
//async function return data in promise object
...
function FileOperations() {
    return __awaiter(this, void 0, void 0, function () {
        var readFileData, dd11, data1, data, readFileData2, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    readFileData = ReadFilePromise();
                    dd11 = Display();
                    console.log(dd11);
                    return [4 /*yield*/, dd11];
                case 1:
                ...
                case 2:
                    ...
                    //write to file 1
                    return [4 /*yield*/, WriteFilePromise("AAAAAAAAAA")];
                case 3:
                    //let parseData = JSON.parse(data);
                    //write to file 1
                    _a.sent();
                    console.log("Write file done -1 ");
                    return [4 /*yield*/, ReadFilePromise()];
                case 4:
                    readFileData2 = _a.sent();
